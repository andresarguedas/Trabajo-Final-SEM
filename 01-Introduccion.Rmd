...
**1)** Definir como modelo poblacional el obtenido por Sura-Fonseca (2020) **(página 99 de la tesis)** como modelo de referencia teórico cuyas cargas factoriales se utilizarán para la generación de los datos simulados.
...
**AQUÍ VA UNA DESCIPCIÓN BREVE DE CADA ETAPA DEL TRABAJO**