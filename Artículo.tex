...
(Vargas-Halabí \& Mora-Esquivel, \protect\hyperlink{ref-slack}{2017})
...
(2020) \textbf{(página 99 de la tesis)} como modelo de referencia
teórico cuyas cargas factoriales se utilizarán para la generación de los
datos simulados.
...
\textbf{AQUÍ VA UNA DESCIPCIÓN BREVE DE CADA ETAPA DEL TRABAJO}
...
\leavevmode\hypertarget{ref-slack}{}%
Vargas-Halabí, T., \& Mora-Esquivel, R. (2017). Tamaño de la muestra en
modelos de ecuaciones estructurales con constructos latentes: Un método
práctico. \emph{Actualidades Investigativas en Educación}, \emph{17},
1-34. Recuperado de
\url{https://revistas.ucr.ac.cr/index.php/aie/article/view/27294}
\end{cslreferences}
